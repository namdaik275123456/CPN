            ...
            >
                <template #cell(status)="row">
                    <b-form-checkbox
                        ...
                        @change="confirmStatusChange(row.item)"
                    ></b-form-checkbox>
                </template>
            </b-table>
                ...
                departments: [
                    {
                        ...
                        department: "BTEC HN",
                        status: true,
                        updated_at: "12/17/2024 15:16",
                        updated_by: "TrangNT317",
                    },
                    {
                        id: 2,
                        stt: 2,
